...
internal final class BleService: NSObject {
   ...
   // private var discoveredPeripheral: CBPeripheral?
    ...
    //Replace the private property discoveredPeripheral with:
    private var attachingWith: (peripheral: CBPeripheral?, suuid: CBUUID?, isAttached: Bool) = (nil, nil, false)
    
    //Modify the class initialiser function:
    init(defaults: UserDefaults = UserDefaults.standard) {
            ud = defaults
        super.init()
        //In BleService initialiser, add: call to setupStateMaps and instantiation of the machine property:
    ...
    //Immediately after the BlsService initialiser, add two private functions:
    ...
    // Add two new functions to the private functions section:
...
// After the BleService class, add an Actions extension with a single action function
...
extension BleService {
    ...
    // In BleService, Actions extension, add:
    ...
    // In the Actions extension, add a new action:
    ...
    func performNotifyAttached(thisEvent: BEvent, thisState: BState) {
            ...
            // Modify the performNotifyAttached function:
...
//
 extension BleService: CBCentralManagerDelegate {
    ...
    func centralManagerDidUpdateState(_ central: CBCentralManager) {
        ...
        // In BleService: In CBCentralManagerDelegate extension, didUpdateState function, add:
     ...
     //In CBCentralManagerDelegate extension, add:
